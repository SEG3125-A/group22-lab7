...
function ProductsFR() {
  return (
    <div>
        ...
        <div name='progress'>
            <Checkoutheader progress={55} next={'/checkoutFr'} back={'/servicesFr'} lan={'/products'}/>
        </div>
        ...
        <div class="container" className="flex h-screen">
            <div className='flex-1 p-4 border border-gray-200'>
                ...
                <div class="shampoo1">
                    ...
                    <img src="shampoo.jpg" className="max-w-48"/>
                </div>
                <div class="shampoo2">
            ...
            <div className='flex-1 p-4 border border-gray-200'>
                ...
                <div class="product1">
                    ...
                    <img src="conditioner.jpg" className="max-w-48"/>
                </div>
                <div class="product2">
            ...
            <div className='flex-1 p-4 border border-gray-200'>
                ...
                <div class="styling1">
                    ...
                    <img src="product.jpg" className="max-w-28"/>
                </div>
                <div class="styling2">
